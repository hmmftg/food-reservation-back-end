module github.com/hmmftg/food-reservation-back-end
...
require (
	...
	github.com/hmmftg/requestCore v0.16.5
...
require (
	...
	github.com/samber/slog-fiber v1.17.2 // indirect
	github.com/samber/slog-formatter v1.1.2 // indirect
